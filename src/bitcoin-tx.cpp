...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Horrorcoin Core horrorcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  horrorcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded horrorcoin transaction") + "\n" +
              "  horrorcoin-tx [options] -create [commands]   " + _("Create hex-encoded horrorcoin transaction") + "\n" +
              "\n";
