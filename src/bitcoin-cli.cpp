...
std::string HelpMessageCli()
{
    ...
    strUsage += "  -conf=<file>           " + strprintf(_("Specify configuration file (default: %s)"), "horrorcoin.conf") + "\n";
    ...
    strUsage += "\n" + _("SSL options: (see the Horrorcoin Wiki for SSL setup instructions)") + "\n";
...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help") || mapArgs.count("-version")) {
        ...
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  horrorcoin-cli [options] <command> [params]  " + _("Send command to Horrorcoin Core") + "\n" +
                  "  horrorcoin-cli [options] help                " + _("List commands") + "\n" +
                  "  horrorcoin-cli [options] help <command>      " + _("Get help for a command") + "\n";
